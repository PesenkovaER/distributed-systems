...
| Компонент | Порт | Протокол | Задача |
|-----------|------|----------|--------|
| Клиент | — | HTTP → 8000 | шифрование, отправка |
| Координатор | 8000 | HTTP / HTTPS+mTLS | балансировка, failover |
| Сервер 1 | 5001 | HTTPS+mTLS | обработка (основной) |
| Сервер 2 | 5002 | HTTPS+mTLS | обработка (резервный) |
| CA | — | — | подпись сертификатов |
| Fernet key | — | — | шифрование |
